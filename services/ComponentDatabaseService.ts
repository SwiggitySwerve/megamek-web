...
// Structure data
export const STRUCTURE_DATA: StructureVariant[] = [
  {
...
// Armor data
export const ARMOR_DATA: ArmorVariant[] = [
  {
    id: 'standard_armor',
    name: 'Standard Armor',
    type: 'armor',
  ...
  },
  {
    ...
    weight: 0,
    criticalSlots: {
      centerTorso: [], leftTorso: [], rightTorso: [], leftArm: [], rightArm: [], leftLeg: [], rightLeg: []
    },
    features: ['Light Ferro-Fibrous'],
    armorPointsPerTon: 16,
    maxArmorPoints: 0,
    placementType: 'dynamic',
    totalSlots: 7
