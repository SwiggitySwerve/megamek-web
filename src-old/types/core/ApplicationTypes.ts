 ...
 * 
 * Defines Data Transfer Objects (DTOs) and view-specific interfaces used by the API and Frontend.
 * These types bridge the gap between the raw data schema and the core domain model.
 */

import { TechBase } from './BaseTypes';
