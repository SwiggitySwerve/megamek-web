...
### Requirement: Weapons Tab (separate from Equipment)
**Reason**: Weapons functionality is now merged into the unified Equipment tab to match MekLab workflow and reduce tab fragmentation.
**Migration**: All weapon browsing and selection is handled in Equipment tab.
