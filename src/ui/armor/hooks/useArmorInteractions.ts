...
export function useArmorTouchControls(
  ...
  handleTouchStart: (e: React.TouchEvent, location: string, currentValue: number, isRear: boolean) => void;
  handleTouchMove: (e: React.TouchEvent) => void;
  handleTouchEnd: () => void;
  touchState: { location: string; startY: number; startValue: number; isRear: boolean } | null;
} {
