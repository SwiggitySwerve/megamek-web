...
const ArmorDistributionPresets: React.FC<ArmorDistributionPresetsProps> = ({
  ...
  const calculateDistribution = (preset: Preset): ArmorDistribution => {
    ...
    let totalUsed = 0;
    Object.values(distribution).forEach((loc: { front: number; rear: number }) => {
          ...
          <div className="bg-gray-900 rounded p-3">
            ...
            <div className="text-xs space-y-1">
              {(() => {
                ...
                const totalUsed = Object.values(dist).reduce((sum: number, loc: { front: number; rear: number }) => sum + loc.front + loc.rear, 0);
