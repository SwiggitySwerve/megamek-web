...
import { EditableUnit, MECH_LOCATIONS } from '../../../types';
import type { ArmorAllocationType } from '../../../types';
import { ArmorProfile, ARMOR_TYPES } from '../../../lib/armorTypes';

const normalizeArmorType = (armorType?: ArmorAllocationType): ArmorProfile => {
  if (!armorType) {
...
interface PatchworkArmorPanelProps {
  unit: EditableUnit;
  onArmorTypeChange: (location: string, armorType: ArmorProfile) => void;
  readOnly?: boolean;
}
...
const PatchworkArmorPanel: React.FC<PatchworkArmorPanelProps> = ({
  ...
  const getArmorTypeForLocation = useCallback((location: string): ArmorProfile => {
  ...
  const handleArmorTypeChange = useCallback((location: string, armorType: ArmorProfile) => {
...
function getRequiredSlotsForLocation(armorType: ArmorProfile, location: string, unit: EditableUnit): number {
