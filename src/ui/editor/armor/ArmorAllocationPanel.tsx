...
import { IArmorAllocation } from '../../../types/Armor';
                  ...
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      onChange={(e) => onArmorLocationChange(
                        ...
                        armorAllocation[selectedSection as keyof typeof armorAllocation].rear || 0
                      )}
                      disabled={readOnly}
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => {
                    ...
                    onArmorLocationChange(selectedSection, maxFront, armorAllocation[selectedSection as keyof typeof armorAllocation].rear || 0);
                  }}
                  disabled={readOnly}
