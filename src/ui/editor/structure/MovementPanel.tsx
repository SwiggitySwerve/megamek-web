...
const MovementPanel: React.FC<MovementPanelProps> = ({
  ...
  const movementData = unit.data?.movement as { jump_type?: string; mech_jump_booster_mp?: number } | undefined;
  const jumpType = movementData?.jump_type || 'Jump Jet';
  const mechJumpBoosterMP = movementData?.mech_jump_booster_mp || 0;
