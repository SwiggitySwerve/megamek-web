...
import { EditableUnit, RulesLevel, TechBase } from '../../../types';
    ...
    <div className="basic-info-panel bg-white rounded-lg border border-gray-300 shadow-sm p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center">
          ...
          <input
            type="text"
            value={typeof unit.data?.clan_name === 'string' ? unit.data?.clan_name : ''}
        ...
        <div className="flex items-center">
          ...
          <input
            type="text"
            value={typeof unit.data?.source_era === 'string' ? unit.data.source_era : ''}
        ...
        <div className="flex items-center">
          ...
          >
            ...
            <option value={TechBase.MIXED}>Mixed Tech</option>
          </select>
        </div>
        ...
        <div className="flex items-center">
          ...
          <input
            type="number"
            value={typeof unit.data?.manual_bv === 'number' ? unit.data.manual_bv : ''}
