...
import { EditableUnit, RulesLevel } from '../../../types';
...
const SummaryPanel: React.FC<SummaryPanelProps> = ({
  ...
  const earliestYear = useMemo(() => {
    ...
    const structureType = unit.data?.structure?.type || 'standard';
    const engineType = unit.data?.engine?.type || 'fusion';
    const rulesLevel = unit.data?.rules_level;
    const isPrimitive = rulesLevel === '1' || rulesLevel === 'Primitive' || rulesLevel === RulesLevel.INTRODUCTORY;
