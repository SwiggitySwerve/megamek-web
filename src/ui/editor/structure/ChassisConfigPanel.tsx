...
import { EditableUnit, UnitConfig, RulesLevel } from '../../../types';
import { getMaxArmorPoints, getMaxArmorPointsForLocation } from '../../../lib/internalStructureTable';
    ...
    <div className="chassis-config-panel bg-white rounded-lg border border-gray-300 shadow-sm p-4">
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center">
          ...
          <select
            value={unit.data?.rules_level === 'Primitive' ? 'Primitive' : 'Standard'}
            onChange={(e) =>
              onUnitChange(updateUnitData(unit, { rules_level: e.target.value as RulesLevel }))
            }
            disabled={readOnly}
