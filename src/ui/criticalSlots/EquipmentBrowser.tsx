...
import { EquipmentObject, TechBase as CanonicalTechBase } from '../../types'
import { ALL_EQUIPMENT_VARIANTS, Equipment, TechBase as EquipmentTechBase, EquipmentVariant } from '../../data/equipment'
...
function convertLocalEquipmentToObject(variant: LocalEquipmentVariant): EquipmentObject {
  ...
  const normalizedTechBase: CanonicalTechBase =
    variant.techBase === 'IS'
      ? CanonicalTechBase.INNER_SPHERE
      : CanonicalTechBase.CLAN
      ...
      Object.entries(equipment.variants).forEach(([techBase, variant]) => {
        try {
          ...
          const flattennedVariant: LocalEquipmentVariant = {
            ...
            name: equipment.name,
            category: equipment.category,
            techBase: techBase as EquipmentTechBase,
            weight: typedVariant.weight,
            crits: typedVariant.crits,
