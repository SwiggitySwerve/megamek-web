...
import { ComponentConfiguration, EngineType, GyroType, StructureType, ArmorType, HeatSinkType } from '../../types'
import { 
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 items-center">
              ...
              <select 
                ...
                onChange={e => {
                  const selected = JSON.parse(e.target.value) as ComponentConfiguration;
                  changeEngine(selected.type as EngineType);
                }}
                className="bg-gray-700 text-white text-xs p-1 rounded border border-gray-600 focus:border-blue-500"
              >
