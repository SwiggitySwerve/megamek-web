...
export function ShareIcon({ className = '', size }: IconProps): JSX.Element {
  return (
    <SvgIcon
      fill="none"
      viewBox="0 0 24 24"
...
export function InboxIcon({ className = '', size }: IconProps): JSX.Element {
  return (
    <SvgIcon
      fill="none"
      viewBox="0 0 24 24"
...
export function RefreshIcon({ className = '', size }: IconProps): JSX.Element {
  return (
    <SvgIcon
      size={size}
      fill="none"
