...
export class SlotCalculationManager {
   ...
   */
  calculateRequiredSlots(config: UnitConfiguration, equipment: EquipmentObject[]): SlotRequirements {
   ...
   */
  calculateSlotUtilization(config: UnitConfiguration, equipment: EquipmentObject[]): SlotUtilization {
    ...
    const byLocation: SlotUtilization['byLocation'] = {};
   ...
   */
  private calculateEquipmentSlots(equipment: EquipmentObject[]): number {
   ...
   * Get ammo slots
   */
  private getAmmoSlots(equipment: EquipmentObject[]): number {
   ...
   */
  private distributeSlotsByLocation(config: UnitConfiguration, equipment: EquipmentObject[]) {
   ...
   */
  private generateUtilizationRecommendations(byLocation: SlotUtilization['byLocation'], bottlenecks: string[]): string[] {
