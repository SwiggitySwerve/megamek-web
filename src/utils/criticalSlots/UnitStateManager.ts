...
import { MechConstructor } from './MechConstructor';
import { UnitValidationResult } from './UnitCriticalManagerTypes';
...
export class UnitStateManager {
  ...
  getUnitSummary(): { 
    ...
    equipmentByLocation: Record<string, EquipmentAllocation[]> 
  } {
    return {
   ...
   */
  getValidation(): UnitValidationResult {
