...
export const ARMOR_SPECIFICATIONS: Record<ArmorType, ArmorSpecification> = {
  ...
  [ArmorType.FERRO_FIBROUS]: {
    type: ArmorType.FERRO_FIBROUS,
  ...
  [ArmorType.FERRO_FIBROUS_CLAN]: {
    type: ArmorType.FERRO_FIBROUS_CLAN,
  ...
  [ArmorType.LIGHT_FERRO]: {
    type: ArmorType.LIGHT_FERRO,
  ...
  [ArmorType.HEAVY_FERRO]: {
    type: ArmorType.HEAVY_FERRO,
...
export function validateArmorAllocation(
  ...
  if (tonnage >= 60 && armorType === ArmorType.STANDARD) {
...
export function getArmorTypeRecommendations(
  ...
  if (tonnage >= 60 && currentArmorType === ArmorType.STANDARD) {
    if (techBase === 'Clan') {
  ...
  if (tonnage >= 80 && currentArmorType === ArmorType.STANDARD) {
    recommendations.push('Heavy units benefit significantly from advanced armor types');
  }
  
  if (currentArmorType === ArmorType.FERRO_FIBROUS && techBase === 'Clan') {
