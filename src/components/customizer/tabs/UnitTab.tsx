...
export function UnitTab({
  ...
  return (
    ...
    >
      ...
      {/* Close button - always visible with dark X */}
      {canClose && !isEditing && (
        <button
          onClick={handleCloseClick}
          className="flex-shrink-0 w-5 h-5 flex items-center justify-center rounded bg-slate-300 text-slate-800 hover:text-white hover:bg-red-600 transition-colors"
          title="Close (Ctrl+W)"
        >
