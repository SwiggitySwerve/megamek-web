 ...
 * PilotCareerTab
 *
 * Career-history timeline tab for the Pilot Detail page.
 * Displays filterable event timeline with selected-event details.
 */
...
export interface PilotCareerTabProps {
  pilotId: string;
  pilotName: string;
}
...
export function PilotCareerTab({
  pilotId,
  pilotName,
